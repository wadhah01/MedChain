...
class PatientContract extends PrimaryContract {
    ...
    //return list of doctors having access 
   //check validity of syntax after running /////////////////////////////////////////
    async getAllowedDoctors(ctx,patientId){
        let patient = await this.readPatient(ctx, patientId);
       return patient.permissionGranted.filter((element)=>element!="hosp1admin" && element!="hosp1admin")
